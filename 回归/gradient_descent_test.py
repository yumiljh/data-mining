...
theta = gradient_descent(theta, X, y, alpha, False)
print "BGD:", theta
print error_function(theta, X, y)
...
theta2 = gradient_descent(theta2, X, y, alpha, True)
print "SGD:", theta2
print error_function(theta2, X, y)
